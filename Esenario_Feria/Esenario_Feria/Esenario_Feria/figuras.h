...
class CFiguras
{
	...
	void prisma_4_text(GLuint text_front, GLuint text_back, GLuint text_right, GLuint text_left, GLuint text_top, GLuint text_bot);
...
void CFiguras::plano(GLfloat largo, GLfloat alto, GLuint textura) {
	glBindTexture(GL_TEXTURE_2D, textura);
	glBegin(GL_QUADS); //plano
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(-largo / 2.0, -alto / 2.0, 0.0);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(largo / 2.0, -alto / 2.0, 0.0);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(largo / 2.0, alto / 2.0, 0.0);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(-largo / 2.0, alto / 2.0, 0.0);
	glEnd();
}

void CFiguras::prisma_4_text(GLuint text_front, GLuint text_back, GLuint text_right, GLuint text_left, GLuint text_top, GLuint text_bot)  //Funcion creacion prisma con 6 texturas, una de para cada cara
{
	...
	glBindTexture(GL_TEXTURE_2D, text_front);
	glBegin(GL_POLYGON);	//Front
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[4]);
	...
	glBindTexture(GL_TEXTURE_2D, text_right);
	glBegin(GL_POLYGON);	//Right
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[3]);
	...
	glBindTexture(GL_TEXTURE_2D, text_back);
	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	...
	glBindTexture(GL_TEXTURE_2D, text_left);
	glBegin(GL_POLYGON);  //Left
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	...
	glBindTexture(GL_TEXTURE_2D, text_bot);
	glBegin(GL_POLYGON);  //Bottom
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
	...
	glBindTexture(GL_TEXTURE_2D, text_top);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[5]);
