...
class CFiguras
{
	...
	void skybox(GLfloat largo, GLfloat altura, GLfloat profundidad, GLuint text);	//Funcion creacion cielo
...
void CFiguras::skybox(GLfloat largo, GLfloat altura, GLfloat profundidad, GLuint text)  //Funcion creacion cielo
{
